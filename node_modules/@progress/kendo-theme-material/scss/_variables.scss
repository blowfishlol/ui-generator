...
$text-color: rgba(black, .4) !default; // TODO: use opaque color
...
// Action buttons
$action-button-text: rgba( $accent, .87 );
$action-button-hovered-bg: rgba( $accent, .12 );
$action-button-pressed-bg: rgba( $accent, .16 );
...
$input-focused-border: rgba( $hovered-border, .48 ) !default;
